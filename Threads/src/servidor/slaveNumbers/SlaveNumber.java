...
public class SlaveNumber {
    ...
    static class DisponivelHandler implements HttpHandler {
        public void handle(HttpExchange exchange) throws IOException {
            System.out.println("Requisição recebida em /disponivel de " + exchange.getRemoteAddress());
            String response = "sim";
    ...
    static class NumerosHandler implements HttpHandler {
        public void handle(HttpExchange exchange) throws IOException {
            System.out.println("Requisição recebida em /numeros de " + exchange.getRemoteAddress());
